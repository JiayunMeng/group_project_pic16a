...
def plot_confusion_matrix(model,X_test, y_test):
    ''' Plots a confusion matrix showing realationship between true and predicted labels
    Args:
        model: the machine learning model we use
        X_test: a dataframe, predictor test data
        y_test: a dataframe, outcome test data
    Returns:
        None
    '''
    y_test_pred = model.predict(X_test) # get the predicted label
    c = confusion_matrix(y_test, y_test_pred) #visualize confusion matrix
    ax= plt.subplot()
